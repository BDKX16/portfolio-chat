...
const projects = [
  {
    ...
    githubUrl: "https://github.com/BDKX16/bike-projecto",
    features: [
      ...
      "Notificaciones con Nodemailer SMTP",
    ...
    challenges: [
      ...
      "Integración de firmware ESP32 con backend Node.js vía HTTPS",
